    ...
    <div className="main">
      <div className="navbar">
        <h3 className="heading">
          <RiCharacterRecognitionLine className="iconNav"/> <h3 className="headingText"> Ashar's Weather Application </h3>
        </h3>
      </div>
      ...
      <div className="wrapper">
        ...
        {result ? (
            ...
            <div className="allCard">
              <div className={result.main?.temp > 20   ? "cardTemp" : "card"}>
                {result.message ? (
                  ...
                  <>
                  {result.main?.temp > 20 ? <IoMdSunny className="sunIcon" /> : <IoMdPartlySunny className="sunIcon"/>}
              ...
              <div className="recentSearch">
                ...
                {recent.slice(1,3).map((x) => (
                  <div className={x.main?.temp > 20   ? "cardTemp" : "card"}>
                     {x.main?.temp > 20 ? <IoMdSunny className="sunIcon" /> : <IoMdPartlySunny className="sunIcon"/>}
          ...
          <h3 className="city">Welcome to Ashar's Weather App </h3>
        )}
      </div>
    </div>
  );
